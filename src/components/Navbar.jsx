...
const Navbar = forwardRef((props, ref) => {
    ...
    const Categories = ["Yema Toriya", "Mama", "Houdaifa", "Souhaib"];
            ...
            <div className="border-b border-gray-200">
              <div className="h-16 flex items-center">
                ...
                <div className="ml-auto flex items-center">
                  ...
                  {show_search_input && <input type="text" className="block w-44 h-8 px-2 bg-gray-50 border border-orange-500 shadow text-sm opacity-90 focus:outline-none focus:border-0 focus:ring-yellow-500 focus:ring-2 rounded-md"/>}
                  ...
                  <div className="ml-4 flow-root lg:ml-6">
                    <button onClick={() => console.log('')} className="group -m-2 p-2 flex items-center">
                      ...
                      <span className="ml-2 text-sm font-medium text-white text-center bg-orange-400 hover:bg-orange-500 rounded-full w-5 h-5">{}</span>
                    </button>
                  </div>
                </div>
              </div>
